...
- [x] Operational vs conversational dashboard split — floor-metrics endpoint + tiles done (kept separate; runs and conversations never summed). Live-map overlay pending (browser).
