# O Assistente e o Blueprint

O Assistente monta uma operação inteira a partir de uma conversa. O que o torna diferente
...
## Rotas
    ...
    POST /api/assistant/assistant/turn
    POST /api/assistant/assistant/confirm
