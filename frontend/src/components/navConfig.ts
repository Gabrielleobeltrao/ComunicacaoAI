...
/**
 * A ordem das camadas: quem existe, o que o escritório possui e o que acontece.
 *
 * COMUNIDADE era a quarta, e não é mais um lugar: o que vem de terceiro aparece dentro de
 * Apps e de Ferramentas, na mesma lista e na mesma busca. Um destino separado dizia que
 * instalar algo de outra pessoa é uma atividade à parte de usar um App — e não é.
 */
