...
import type { Blueprint } from '../../lib/assistant'
...
export function OfficePreview({ blueprint }: { blueprint: Blueprint | null | undefined }) {
  ...
  if (preview.floors.length === 0) {
    return (
      <Card>
        <p style={{ fontSize: 13, color: 'var(--text-muted)' }} data-testid="assistant-office-empty">
  ...
  return (
    <div className="flex flex-col gap-3" data-testid="assistant-office-preview">
      <Card>
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-2" data-testid="assistant-office-totals">
            ...
            {preview.floors.length > 1 && (
              <label className="flex items-center gap-2" style={{ fontSize: 12.5, color: 'var(--text-muted)' }}>
                ...
                <Select
                  ...
                  data-testid="assistant-office-floor-select"
                  style={{ minWidth: 200 }}
                >
          ...
          <p id="assistant-office-desc" style={{ fontSize: 12.5, color: 'var(--text-muted)' }} data-testid="assistant-office-description">
            {describeFloor(andar)}
          </p>

          <p style={{ fontSize: 12, color: 'var(--text-faint)' }} data-testid="assistant-office-notice">
      ...
      */}
      <section aria-label="Mapa do escritório proposto" aria-describedby="assistant-office-desc" data-testid="assistant-office-map">
