import { LAYERS } from '../../lib/assistant'
import type { AssistantPreview, BlueprintLayer } from '../../lib/assistant'
...
export function Layers({
  ...
  return (
    <div className="flex flex-col gap-2" data-testid="assistant-layers">
      <div>
        ...
        {LAYERS.map((c) => {
          ...
          return (
            <button
              ...
              data-testid={`assistant-layer-${c.key}`}
