import type { AssistantStatus, ChecklistItem, PreviewItem } from '../../lib/assistant'
...
export const statusTone = (status: AssistantStatus): 'neutral' | 'success' | 'warning' | 'danger' | 'brand' =>
