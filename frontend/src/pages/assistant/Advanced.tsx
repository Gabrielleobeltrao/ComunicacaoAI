...
import type { ApplyStep, AssistantProject } from '../../lib/assistant'
...
export function Advanced({
  ...
  return (
    <details data-testid="assistant-advanced">
      ...
      <div className="flex flex-col gap-3" style={{ paddingTop: 10 }}>
        <Card>
          <div className="flex flex-col gap-2" data-testid="assistant-provider">
        ...
        {steps.length > 0 && (
          <Card>
            <div className="flex flex-col gap-1" data-testid="assistant-steps">
        ...
        <Card>
          <div className="flex flex-col gap-2" data-testid="assistant-danger">
            <strong style={{ fontSize: 13 }}>Encerrar este projeto</strong>
            {confirmando === null && (
              <div className="flex flex-wrap gap-2">
                <Button variant="secondary" onClick={() => setConfirmando('archive')} disabled={carregando} data-testid="assistant-archive">
                  Arquivar
                </Button>
                {project.status === 'applied' && (
                  <Button variant="secondary" onClick={() => setConfirmando('rollback')} disabled={carregando} data-testid="assistant-rollback">
            ...
            {confirmando === 'archive' && (
              <div className="flex flex-col gap-2" data-testid="assistant-confirm-archive">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button onClick={onArquivar} data-testid="assistant-archive-confirm">
                    Arquivar
                  </Button>
                </div>
              </div>
            ...
            {confirmando === 'rollback' && (
              <div className="flex flex-col gap-2" data-testid="assistant-confirm-rollback">
                <p style={{ fontSize: 13 }}>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button onClick={onDesfazer} data-testid="assistant-rollback-confirm">
                    Desfazer
                  </Button>
                </div>
              </div>
