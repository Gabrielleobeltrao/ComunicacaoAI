...
## Corpus Check
- 290 files · ~309,140 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2541 nodes · 5908 edges · 169 communities (146 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8622ce8`
...
### Community 2 - "schedule.ts"
Cohesion: 0.38
Nodes (6): EVERY_MINUTES, EveryMinutes, isValidRecurrence(), parseTime(), Recurrence, recurrenceToCron()
...
Cohesion: 0.05
Nodes (61): AGENT_EVENT_SOURCES, AGENT_EVENT_STATUSES, AgentEventSource, AgentEventStatus, AgentExecutionEvent, clarificationsSince(), finalizeAgentEvent(), finalizeAgentEventSafe() (+53 more)

### Community 6 - "src/index.ts"
Cohesion: 0.04
Nodes (51): backfillAgentEventAttempts(), ensureAgentEventIndexes(), ensureAuditIndexes(), stopEmbeddedEngine(), ensureExecutionIndexes(), ensureDelegationIndexes(), app, AVATAR_MIME_TYPES (+43 more)
...
Cohesion: 0.14
Nodes (24): missingCapability(), AppStepContext, AppStepError, executeAppStep(), resolveArgs(), AppActionEvent, appActionEvents, buildAction() (+16 more)
...
Cohesion: 0.05
Nodes (70): sourceSettingsOf(), LivePassage, livePassagesFor(), liveStepIdFor(), STEP(), AgentCall, delay(), DeliverCall (+62 more)
...
Cohesion: 0.10
Nodes (29): runEventKey(), createLiveTracker(), findAutomation(), publishedSourceFingerprint(), agentIdsOf(), buildDeps(), processRun(), trackersFor() (+21 more)
...
Cohesion: 0.16
Nodes (40): buildEventTriggerDefinition(), createEventTrigger(), describeEventTriggerFlow(), EventTriggerError, getEventTriggerForAgent(), isEventTrigger(), listEventTriggers(), readEventTriggerConfig() (+32 more)

### Community 31 - "runRepository.ts"
Cohesion: 0.12
Nodes (24): artifacts, findRun(), insertRunIdempotent(), listArtifacts(), listRuns(), listStepRuns(), MAX_RUN_CLAIMS, requestCancel() (+16 more)
...
Cohesion: 0.15
Nodes (17): chunkTelegram(), FetchImpl, MailTransport, sendTelegram(), createConnection(), CreateConnectionInput, isNonEmpty(), normalizeName() (+9 more)
...
Cohesion: 0.15
Nodes (25): getAgentById(), webhookEndpoint(), listAgentAutomations(), listRoutines(), readSourceFromDefinition(), RoutineError, RoutineSource, STEP_SOURCE (+17 more)
...
Cohesion: 0.13
Nodes (24): ensureAppActionIndexes(), ensureInstallationIndexes(), ensureNavigationIndexes(), ensurePrivateAppIndexes(), ensureAutomationIndexes(), ensureRunIndexes(), backfillSourceFingerprints(), ensureSourceCheckpointIndexes() (+16 more)
...
Cohesion: 0.14
Nodes (27): buildingOverview(), ensureDefaultBuilding(), agentCanDelegate(), capabilityMissingTool(), DELEGATION_MAX_DEPTH, finishDelegation(), startDelegation(), playgroundDelegationDeps() (+19 more)
...
Cohesion: 0.13
Nodes (26): buildSynthesisContext(), describeMember(), describePlan(), ExecutionTask, fallbackPlan(), inputFromDependencies(), INSTRUCOES_DE_SINTESE, limitationNote() (+18 more)
...
Cohesion: 0.15
Nodes (12): AutomationVersion, ValidationError, CONNECTION_CATALOG, resolveOwnedSectorId(), automationRouter, connectionRouter, fail(), notFound() (+4 more)
...
Cohesion: 0.06
Nodes (28): clarificationGuidance(), CLARIFY_LIMIT, formatOptions(), resolveChoice(), semAcento(), broadcastMessage(), respondWithAgentIfLinked(), AUXILIARY_MODEL (+20 more)
...
Cohesion: 0.13
Nodes (27): ensureActivationMode(), assertOwnedAgentRefs(), assertOwnedSectorRefs(), AutomationValidationError, collectSectorRefs(), createAutomation(), CreateAutomationInput, defaultDefinition() (+19 more)
...
Cohesion: 0.15
Nodes (17): createInstallation(), CreateInstallationInput, deleteInstallation(), getInstallation(), installationPublic(), installations, LEGACY_APP_VERSION, markInstallationTested() (+9 more)

### Community 104 - "executeSectorTeam"
Cohesion: 0.24
Nodes (11): emitAgentEvent(), executeSectorTeam(), participationTelemetry(), recordChildRun(), runWithRetry(), stageInstruction(), assembleWithoutModel(), dedupeAgainst() (+3 more)
...
Cohesion: 0.15
Nodes (15): adapters, manifest, adapters, manifest, adapters, manifest, NativeFactory, hubspotTools() (+7 more)
...
### Community 146 - "runAgentTask"
Cohesion: 0.31
Nodes (9): executeRoutineStep(), persistWithRetry(), childContext(), runAgentTask(), breadthNotice(), buildRetrievalQuery(), CitableSource, formatContextWithSources() (+1 more)
...
Cohesion: 0.07
Nodes (63): anthropicUsage(), askAux(), AUXILIARY_MODEL, buildClient(), checkGuardrail(), DEFAULT_MODEL, extractIdentity(), extractStructuredOutput() (+55 more)

### Community 151 - "builtinTools.ts"
Cohesion: 0.14
Nodes (17): resolveAppGrantTools(), adapters, manifest, APP_GUIDES, BUILTIN_APPS, BuiltinApp, BuiltinAppGuide, builtinAppsCatalog() (+9 more)

### Community 152 - "db.ts"
Cohesion: 0.11
Nodes (17): auth, db, mongoClient, col, DelegationFinish, DelegationRecord, DelegationStart, DelegationStatus (+9 more)

### Community 153 - "floors.ts"
Cohesion: 0.11
Nodes (28): legacyWorkingMap(), liveStatesEtag(), agentStatesForFloor(), floorMetrics, BuildingLanguage, BuildingPatch, buildings, DEFAULT_TIMEZONE (+20 more)
...
### Community 165 - "collaborationGate.ts"
Cohesion: 0.33
Nodes (5): CollaborationDecision, CollaborationDenyCode, GateContext, GateTarget, FloorCommunicationConfig

### Community 168 - "official/index.ts"
Cohesion: 0.12
Nodes (11): manifest, adapters, manifest, MODULES, OFFICIAL_ADAPTERS, OFFICIAL_APPS, OfficialAppsError, OfficialModule (+3 more)
...
## Knowledge Gaps
- **617 isolated node(s):** `name`, `version`, `type`, `main`, `dev` (+612 more)
