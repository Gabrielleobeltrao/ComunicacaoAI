...
## Corpus Check
- 176 files · ~179,977 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1787 nodes · 3925 edges · 122 communities (109 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4fcd4ad4`
...
8. `startMongo()` - 23 edges
9. `stopMongo()` - 23 edges
10. `getApp()` - 18 edges
...
Cohesion: 0.19
Nodes (22): runEventKey(), createLiveTracker(), agentIdsOf(), buildDeps(), processRun(), trackersFor(), findRunUnscoped(), insertArtifact() (+14 more)

### Community 1 - "floors.ts"
Cohesion: 0.15
Nodes (21): agentStatesForFloor(), buildingOverview(), floorMetrics, ensureDefaultBuilding(), collection, createFloor(), deleteFloor(), DeleteFloorResult (+13 more)

### Community 2 - "openai.ts"
Cohesion: 0.07
Nodes (70): legacyToolToExecutable(), MAX_TOOL_ITERATIONS, ResolvedTool, resolveHttpTool(), runResolvedTool(), ToolCallRecord, toolInputSchema(), anthropicUsage() (+62 more)
...
Cohesion: 0.04
Nodes (39): stopEmbeddedEngine(), getBuiltinApp(), setActiveAgentId(), app, auxModelFor(), AVATAR_MIME_TYPES, buildStageTransitionOptions(), channelWebhookUrl() (+31 more)

### Community 7 - "audit.ts"
Cohesion: 0.10
Nodes (27): AUDIT_ACTIONS, AUDIT_ACTOR_TYPES, AUDIT_ENTITY_TYPES, AuditActorType, AuditEntityType, AuditEvent, AuditEventPublic, AuditFilters (+19 more)
...
Cohesion: 0.11
Nodes (34): presetSpec(), suggestPresetForCapability(), agentCard(), asOutputFormat(), buildCapabilityMissing(), buildDelegationTools(), CapabilityMissing, capabilityMissingTool() (+26 more)
...
Cohesion: 0.20
Nodes (17): assertOwnedAgentRefs(), assertOwnedSectorRefs(), AutomationValidationError, collectSectorRefs(), createAutomation(), defaultDefinition(), normalizeName(), requireFloor() (+9 more)
...
Cohesion: 0.07
Nodes (35): ACTIVE_TTL_MS, AGENT_BUBBLE_STATES, AgentBubbleState, AgentLiveState, agentLiveStatesForFloor(), AgentLiveStatesResponse, AgentLiveVisualState, AgentSafeDetail (+27 more)
...
Cohesion: 0.22
Nodes (11): createConnection(), CreateConnectionInput, decryptConfig(), isNonEmpty(), normalizeName(), patchConnection(), PROVIDERS, validateConfig() (+3 more)

### Community 42 - "installations.ts"
Cohesion: 0.14
Nodes (18): createInstallation(), CreateInstallationInput, deleteInstallation(), getInstallation(), installations, LEGACY_APP_VERSION, markInstallationTested(), normalizeConfig() (+10 more)
...
Cohesion: 0.12
Nodes (12): AutomationInput, AutomationLimits, AutomationVersion, DEFAULT_LIMITS, DeliveryTarget, ManualTrigger, RetryPolicy, ScheduleTrigger (+4 more)
...
### Community 78 - "floorRoutes.ts"
Cohesion: 0.12
Nodes (18): AgentAppGrant, AuditAction, ValidationError, CONNECTION_CATALOG, appGrantRouter, auditEntity(), auditRequests(), AuditTarget (+10 more)
...
Cohesion: 0.24
Nodes (15): ensureAgentLiveStateIndexes(), ensureAppActionIndexes(), ensureInstallationIndexes(), ensureNavigationIndexes(), ensureAutomationIndexes(), ensureRunIndexes(), ensureBuildingIndexes(), ensureConnectionIndexes() (+7 more)

### Community 106 - "eventTrigger.ts"
Cohesion: 0.28
Nodes (12): buildEventTriggerDefinition(), createEventTrigger(), EventTriggerError, EventTriggerSpec, getEventTriggerForAgent(), isEventTrigger(), listEventTriggers(), updateEventTrigger() (+4 more)
...
Cohesion: 0.21
Nodes (10): chunkTelegram(), FetchImpl, MailTransport, sendTelegram(), Connection, ConnectionStatus, Delivery, DeliveryStatus (+2 more)
...
Cohesion: 0.25
Nodes (10): Agent, Floor, agents, competencyOf(), effectiveTargets(), FloorTarget, floorWorkOverview, sectors (+2 more)
...
## Knowledge Gaps
- **466 isolated node(s):** `AgentEventSource`, `AGENT_EVENT_SOURCES`, `AGENT_EVENT_STATUSES`, `AgentExecutionEvent`, `RoutineStepCall` (+461 more)
