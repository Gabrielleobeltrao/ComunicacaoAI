...
//
// Puro de propósito: a classificação é a regra mais discutível do Assistente, e uma
// regra discutível precisa ser exercitável sem subir nada.
import { test } from 'node:test'
import assert from 'node:assert/strict'

const { classifyJob, classifyBrief, classificationForPrompt, formaPedida } = await import('../dist/assistant/classify.js')
const { detectGaps } = await import('../dist/assistant/nextQuestion.js')
