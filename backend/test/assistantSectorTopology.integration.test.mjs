...
const { createProject, patchProject } = await import('../dist/assistant/repository.js')
...
beforeEach(async () => {
  for (const c of ['buildings', 'offices', 'agents', 'sectors', 'assistant_projects', 'assistant_operations'])
...
const { buildPreview } = await import('../dist/assistant/preview.js')
