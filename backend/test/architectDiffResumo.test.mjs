...
//   arquiteto: "Você tem razão… vou ajustar a proposta removendo qualquer canal"
//   dono:      "E pq está com web-chat, não vamos precisar disso"   ← de novo, igual
//   arquiteto: "Você tem razão… vou remover"
...
// dois. O problema não é o Arquiteto errar — é ele DIZER QUE FEZ. Aqui o servidor passa a
// dizer o que aconteceu de verdade, e a frase do modelo deixa de ser a única fonte.
import { test } from 'node:test'
import assert from 'node:assert/strict'

const { resumoDaMudanca } = await import('../dist/architect/diff.js')
...
const { ehRepeticaoSemEfeito } = await import('../dist/architect/diff.js')
