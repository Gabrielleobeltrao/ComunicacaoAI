...
//
// O Brief é o artefato que faltava: antes dele, o primeiro produto do Assistente era um
...
test('AMEAÇA: todo campo do Brief que o compilador usa está no contrato do modelo', () => {
  const prompt = readFileSync(new URL('../src/assistant/prompt.ts', import.meta.url), 'utf8')
