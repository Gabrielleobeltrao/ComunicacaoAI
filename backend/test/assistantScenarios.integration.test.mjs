...
const { applyBlueprint } = await import('../dist/assistant/apply.js')
const { computeBlueprintHash } = await import('../dist/assistant/blueprint.js')
const { emptyBrief } = await import('../dist/assistant/brief.js')
const { loadOfficeInventory } = await import('../dist/assistant/inventory.js')
const { recheckProject } = await import('../dist/assistant/recheck.js')
const { deriveChecklist } = await import('../dist/assistant/checklist.js')
