...
const { runCritic, normalizeLlmFindings } = await import('../dist/assistant/critic.js')
const { detectArchitecture, mergeSplitRationale, scoreArchitecture } = await import('../dist/assistant/architecture.js')
const { validateResponsibility, specOf } = await import('../dist/assistant/responsibility.js')
const { validateExecutors } = await import('../dist/assistant/executorContract.js')
const { emptyBlueprint } = await import('../dist/assistant/blueprint.js')
