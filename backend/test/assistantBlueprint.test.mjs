...
const { validateOfficeBlueprint, emptyOwnershipContext } = await import('../dist/assistant/validate.js')
const { emptyBlueprint, mergeBlueprintPatch, computeBlueprintHash } = await import('../dist/assistant/blueprint.js')
const { maskSecrets, containsSecret, maskSecretsDeep } = await import('../dist/assistant/secrets.js')
const { deriveChecklist, applyChecklistState, computeReadiness } = await import('../dist/assistant/checklist.js')
const { canTransition, isEditable, isConversable } = await import('../dist/assistant/state.js')
const { diffBlueprints } = await import('../dist/assistant/diff.js')
const L = await import('../dist/assistant/limits.js')
...
test('o Assistente não arma webhook nem gatilho de evento', () => {
