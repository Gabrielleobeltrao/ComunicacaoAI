...
import { ensureKnowledgeMigrationIndexes, migrateAssistantKnowledge } from '../knowledgeMigration.js'

// A migração, rodada À MÃO — nunca no boot.
//
// `node dist/scripts/migrateAssistantKnowledge.js [tenantId]`. Sem argumento, roda para
...
const r = await migrateAssistantKnowledge(tenantId ? { tenantId } : {})
