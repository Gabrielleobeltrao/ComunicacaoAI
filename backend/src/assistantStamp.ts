// A MARCA DE ORIGEM que o Assistente deixa no que ele cria.
//
// Mora fora de `assistant/` de propósito: quem escreve a marca são os módulos de
// domínio (andar, agente, setor, rotina), e um tipo importado de dentro do Assistente
