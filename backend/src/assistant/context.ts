...
export async function loadAppsForPrompt(ownerId: string): Promise<AssistantAppInfo[]> {
 ...
 *
 * Sem isto o Assistente é cego para o escritório existente: ele propõe criar um andar
