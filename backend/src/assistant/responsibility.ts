...
//
// "Função" era um rótulo: o Assistente escrevia `preset: "manager"` e ninguém conferia
 ...
 */
export function validateResponsibility(bp: OfficeBlueprintV1, manifest: AssistantCapabilityManifest | null): ResponsibilityFinding[] {
