...
// O CATÁLOGO VIVO do que o Assistente pode propor.
//
...
export interface AssistantCapabilityManifest {
 ...
 * próprio código. É barato o bastante para ser montado a cada rodada do Assistente, e
 * ser montado a cada rodada é o que garante que ele não fale de um App que a pessoa
 * acabou de desconectar.
 */
export async function buildCapabilityManifest(ownerId: string): Promise<AssistantCapabilityManifest> {
 ...
 */
export function manifestForPrompt(m: AssistantCapabilityManifest): string {
