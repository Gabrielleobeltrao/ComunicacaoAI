// A CONSTITUIÇÃO do Assistente — as regras que não dependem de busca.
//
...
export const ASSISTANT_CONSTITUTION_VERSION = 1

export const ASSISTANT_CONSTITUTION = `CONSTITUIÇÃO DO ASSISTENTE (v${ASSISTANT_CONSTITUTION_VERSION})
...
export const constitutionForPrompt = (): string => ASSISTANT_CONSTITUTION
