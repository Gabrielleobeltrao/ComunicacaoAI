...
const pendentes = db.collection<PendingOperation>('assistant_pending_operations')
 ...
 * operação pendente.
 */
export async function prepararOperacao(ownerId: string, intent: Extract<AssistantIntent, { mode: 'operate' }>): Promise<PrepareOutcome> {
