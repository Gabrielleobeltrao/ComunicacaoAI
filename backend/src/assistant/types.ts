// O Assistente do Escritório — os tipos, e só eles.
//
...
export type AssistantLocale = 'pt' | 'en' | 'es'
export const ASSISTANT_LOCALES: readonly AssistantLocale[] = ['pt', 'en', 'es']
...
export interface AssistantApplyState {
  operationId: string
  status: ApplyStatus
