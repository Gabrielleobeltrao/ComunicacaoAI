...
import type { AssistantWarning, OfficeBlueprintV1 } from './types.js'
 ...
 */
export function repairBlueprintPatch(patch: Record<string, unknown>): { patch: Record<string, unknown>; warnings: AssistantWarning[] } {
 ...
 */
export function repairReuseWithoutTarget(bp: OfficeBlueprintV1, existing?: ExistingResources): { blueprint: OfficeBlueprintV1; warnings: AssistantWarning[] } {
  /**
