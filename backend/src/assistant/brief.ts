...
//
// Antes, o primeiro artefato do Assistente era o Blueprint: ele saía inventando andar,
 ...
 */
export function resolveIntegrations(brief: OperationBrief, manifest: AssistantCapabilityManifest | null): OperationBrief {
