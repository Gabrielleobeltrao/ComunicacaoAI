...
export function buildPreview(bp: OfficeBlueprintV1, ctx: BlueprintOwnershipContext, marcados: Set<string> = new Set(), v2?: OfficeBlueprintV2 | null): AssistantPreview {
